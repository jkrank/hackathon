module.exports = function () {
  ...
  function createUsers (err) {
    ...
    conn.query("CREATE TABLE users( id INTEGER NOT NULL AUTO_INCREMENT, user_name VARCHAR(255), phone_number VARCHAR(255), scores INTEGER, status INTEGER DEFAULT 0, dereg INTEGER DEFAULT 0, PRIMARY KEY(id))engine=INNODB", populate);
  }
